...
///<DateCreated>05/16/2014 13:49:13</DateCreated>
///<DateModified>05/16/2014 13:49:13</DateModified>
    ...
    public class ResultRepository : IRepository<Result>
    {
        ...
        public Result GetById(int Id)
        {
            ...
            if (dr.Read())
            {
                ...
                if (!dr.IsDBNull(dr.GetOrdinal("StableFordPoints"))) result.StableFordPoints = dr.GetInt32(dr.GetOrdinal("StableFordPoints"));
        ...
        public int Insert(Result entity)
        {
            ...
            using (DbCommand command = db.GetStoredProcCommand("uspInsertResult"))
            {
                ...
                db.AddInParameter(command, "@StableFordPoints", DbType.Int32, entity.StableFordPoints);
