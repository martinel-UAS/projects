...
namespace DomainServices
{
    ...
    public class FieldService
    {
        ...
        /// <summary>
        /// Gets a field deleted or not
        /// </summary>
        /// <param name="fieldId">Field identifier</param>
        /// <returns>Field</returns>
        public Field GetFieldByIdDeletedOrNot(int fieldId)
        {
            if (fieldId == 0)
                return null;
            string whereClause = "Id =" + fieldId + " AND (IsDeleted = 0 OR IsDeleted = 1)";
            return fieldRepository.GetByWhereClause(whereClause, "Id").FirstOrDefault();
        }
