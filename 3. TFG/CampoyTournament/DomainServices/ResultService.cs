...
///<DateCreated>05/16/2014 13:49:31</DateCreated>
///<DateModified>05/16/2014 13:49:31</DateModified>
...
namespace DomainServices
{
    ...
    public class ResultService
    {
        ...
        /// <param name="orderBy">Column name</param>
        /// <returns></returns>
        public Result GetResultByMatchHolePlayer(int matchId, int holeId, int playerId, string orderBy)
        {
            string whereClause = "MatchId=" + matchId + " AND HoleId=" + holeId + " AND PlayerId=" + playerId + " AND IsDeleted=0";
            Result result = resultRepository.GetByWhereClause(whereClause, orderBy).FirstOrDefault();
            return result;
        }
        ...
        /// <param name="orderBy">Column name</param>
        /// <returns></returns>
        public bool CheckResultByMatch(int matchId, string orderBy)
        {
            string whereClause = "MatchId=" + matchId + " AND IsDeleted=0";
            Result result = resultRepository.GetByWhereClause(whereClause, orderBy).FirstOrDefault();
        ...
        /// <param name="orderBy">Column name</param>
        /// <returns></returns>
        public List<Result> GetResultByMatchPlayer(int matchId, int playerId, string orderBy)
        {
            string whereClause = "MatchId=" + matchId + " AND PlayerId=" + playerId + " AND IsDeleted=0";
            List<Result> results = resultRepository.GetByWhereClause(whereClause, orderBy);
            return results;
        }
