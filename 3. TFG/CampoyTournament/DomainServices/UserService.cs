...
namespace DomainServices
{
    ...
    public class UserService
    {
        ...
        /// Gets a user
        /// </summary>
        /// <param name="userId">Player identifier</param>
        /// <returns>User</returns>
        public User GetUserByPlayerId(int playerId)
        {
            ...
            string whereClause = "PlayerId=" + playerId;
            return userRepository.GetByWhereClause(whereClause, "Id").FirstOrDefault();
        }

        /// <summary>
        /// Gets a user deleted or not
        /// </summary>
        /// <param name="userId">User identifier</param>
        /// <returns>User</returns>
        public User GetUserByPlayerIdDeletedOrNot(int playerId)
        {
            if (playerId == 0)
                return null;
            string whereClause = "PlayerId =" + playerId + " AND (IsDeleted = 0 OR IsDeleted = 1)";
            return userRepository.GetByWhereClause(whereClause, "Id").FirstOrDefault();
        }
