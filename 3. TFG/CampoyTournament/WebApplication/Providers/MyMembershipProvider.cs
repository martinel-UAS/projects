...
namespace WebApplication.Providers
{
    public class MyMembershipProvider : MembershipProvider
    {
        ...
        public override MembershipUser GetUser(string email, bool userIsOnline)
        {
            ...
            {
                return new MembershipUser("MyMembershipProvider", email, UserManager.User.Id, UserManager.User.Email, null, null, true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            }
            else
            {
                return null;
